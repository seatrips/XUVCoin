...
- Go to your windows XUVwallet
- Go to Help> Debug Window > Console > Type 
```
masternode genkey 
```
...
- Go to Receive > New Address, name it MN01 > Press 
```
OK
```
- Let's copy adress
...
- Go back to your local wallet, go to "My Masternodes" section 
- Press
```
Create
```
- Fill in the needed data and click 
```
oke
```
