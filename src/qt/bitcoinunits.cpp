...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("XUV");
    case mBTC: return QString("mXUV");
    case uBTC: return QString::fromUtf8("μXUV");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("XUVs");
    case mBTC: return QString("Milli-XUVs (1 / 1,000)");
    case uBTC: return QString("Micro-XUVs (1 / 1,000,000)");
    default: return QString("???");
    }
}
