...
private slots:
    ...
    QString BuyXUV(QString OrderType, double Quantity, double Rate);
    QString SellXUV(QString OrderType, double Quantity, double Rate);
