...
{
	resize(1250, 520);
	setWindowTitle(tr("XUV") + " - " + tr("Wallet"));
	qApp->setStyleSheet("QMainWindow { background-image:url(:images/bkg);border:none;font-family:'Open Sans,sans-serif'; }"
		"QPushButton    { color:#ecf0f1; border-radius:5px; border:solid 1px #f39c12; background:#757575;  padding:3px 30px; -webkit-transition: all 0.1s; -moz-transition: all 0.1s; transition: all 0.1s; -webkit-box-shadow: 0px 6px 0px #d35400; -moz-box-shadow: 0px 6px 0px #d35400; box-shadow: 0px 6px 0px #d35400;}"
...
#endif
	setObjectName("XUV");
	setStyleSheet("#XUV { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #dedede, stop: 1 #efefef);  }");
	// Accept D&D of URIs
	setAcceptDrops(true);
...
void BitcoinGUI::createActions()
{
	...
	sendCoinsAction->setToolTip(tr("Send coins to a XUV address"));
	...
	aboutAction = new QAction(QIcon(":/icons/bitcoin1"), tr("&About XUV"), this);
	aboutAction->setToolTip(tr("Show information about XUV"));
	aboutAction->setMenuRole(QAction::AboutRole);
	aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
	aboutQtAction->setToolTip(tr("Show information about Qt"));
	aboutQtAction->setMenuRole(QAction::AboutQtRole);
	optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
	optionsAction->setToolTip(tr("Modify configuration options for XUV"));
...
void BitcoinGUI::createToolBars()
{
	...
	toolbar->setStyleSheet("QToolButton { color: #000000; font-size: 13px; font-weight: 400; padding:5px; font-family: 'Verdana'; border: none; }"
		"QToolButton:hover { background-color: #707070; color: #ffffff; border: none; padding-top: 5px; padding-bottom: 5px; }"
		"QToolButton:checked { background-color: #707070; color: #ffffff; border: none; padding-top: 5px; padding-bottom: 5px; }"
		"QToolButton:pressed { background-color: #707070; color: #ffffff; border: none; padding-top: 5px; padding-bottom: 5px; }"
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
	...
	if (clientModel)
	{
		...
		if (clientModel->isTestNet())
		{
			...
			if (trayIcon)
			{
				trayIcon->setToolTip(tr("XUV client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
	...
	trayIcon->setToolTip(tr("XUV client"));
...
void BitcoinGUI::setNumConnections(int count)
{
	...
	labelConnectionsIcon->setToolTip(tr("%n active connection(s) to XUV network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
	if (event->mimeData()->hasUrls())
	{
		...
		if (nValidUrisFound)
			...
			notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid XUV address or malformed URI parameters."));
	}
